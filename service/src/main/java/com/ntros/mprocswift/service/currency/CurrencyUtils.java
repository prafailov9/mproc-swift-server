...
import com.ntros.mprocswift.exceptions.InvalidDecimalAmountException;
...
public final class CurrencyUtils {
   ...
   * Digit count of the whole number (leading digits + trailing digits) should always be <=
   * NUMBER_MAX_DIGIT_COUNT
   */
  ...
  /**
   * Removes trailing zeroes from given numeric string: 2350482004100000 -> 23504820041 get max of
   * (length - trailing zero count, 1) to keep the decimal point ex: wholeValue=25.00000,
   * trailingDigitsString=00000 returns length=1, keeping '.0' for the whole value -> 25.0
   *
