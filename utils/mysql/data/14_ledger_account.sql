...
-- FX System Accounts
INSERT INTO ledger_accounts (ledger_account_type_id, ledger_account_name, currency_id, wallet_id, merchant_id,
                             external_account_id, is_active)
VALUES (6, 'FX Bridge EUR', 42, null, null, null, true);
INSERT INTO ledger_accounts (ledger_account_type_id, ledger_account_name, currency_id, wallet_id, merchant_id,
                             external_account_id, is_active)
VALUES (6, 'FX Bridge USD', 143, null, null, null, true);
...
INSERT INTO ledger_accounts (ledger_account_type_id,
                             ledger_account_name,
                             currency_id,
                             wallet_id,
                             merchant_id,
                             external_account_id,
                             is_active)
SELECT lat.ledger_account_type_id,
