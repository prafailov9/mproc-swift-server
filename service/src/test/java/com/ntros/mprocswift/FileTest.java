...
//
//    @Test
//    public void fixAddressDataTest() throws URISyntaxException, IOException {
//        generateHashedAddressInsertStatements();
//    }
//
//    /**
...
//     */
//    @Test
//    public void fixAccountDataTest() throws URISyntaxException, IOException {
//        Path source = Paths.get("../persistence/src/main/resources/sql").resolve("05_account_details.sql");
//
...
//                    List<String> numberVals = Stream.of(valuesString.split(", "))
...
//                    valuesString = valuesString.replace("', " + numberVals.get(0), "', '" + account + "'")
//                            .replace(
//                                    account.charAt(account.length() - 1) + "', " + numberVals.get(1)
...
//                });
//        Path dest = Paths.get("../scripts/mysql/data").resolve("05_account_details.sql"); // will create or rewrite the file
...
//     */
//    private void generateHashedAddressInsertStatements() throws URISyntaxException, IOException {
//        Path source = Paths.get("../persistence/src/main/resources/sql/data").resolve("address.sql");
//
...
//        reader.close();
//
//        Path dest = Paths.get("../scripts/mysql").resolve("01_address.sql"); // will create or rewrite the file
//        BufferedWriter writer = Files.newBufferedWriter(dest);
